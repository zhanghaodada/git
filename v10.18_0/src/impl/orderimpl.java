...
public class orderimpl implements orderdao {
	...
	public boolean insertorder(List<Product> pro) {
		...
		try{
			...
			//添加订单，自动生成id，
			String sql="insert into orderinfo(orderno,orderstatus,ordertime) values(?,?,?)";
			int count=qRunner.update(conn, sql,oi.getOrderno(),oi.getOrderstatus(),oi.getOrdertime());			
             //根据订单编号获取Id
