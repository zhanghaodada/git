	...
	<body>
		<div id="div_all" >
			...
			<div id="div_have">
				...
				<div id="have_right">
					<p id="right_p">注册</p>
					<div class="right_res" id="right_name"><p>用户名：</p><input type="text" name="input03"/></div>
					<div class="right_res" id="right_password"><p>密码：</p><input type="text" name="input04"/></div>
					<div id="right_button">
