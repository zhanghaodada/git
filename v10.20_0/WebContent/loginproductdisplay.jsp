...
<title>dp官方旗舰店-商品展示</title>
<link rel="stylesheet" href="css/productdisplay.css" />
<link rel="stylesheet" href="css/loginfrontpage.css" />
...
<script type="text/javascript" src="js/productdisplay.js" ></script>
	...
	<body>
		...
		<div id="div_head">
			...
			<div id="div_head_list01">我的淘宝
			<div id="list01_have">
				<a href="#"><div class="list01_myorder">我的订单</div></a>
				<a href="acc_managerservlet"><div class="list01_myorder">账号管理</div></a>
			</div>
			</div>
